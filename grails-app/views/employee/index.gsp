		...
		<div id="list-employee" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="hours" title="${message(code: 'employee.hours.label', default: 'Hours')}" />
					
						<g:sortableColumn property="wage" title="${message(code: 'employee.wage.label', default: 'Wage')}" />
				...
				<g:each in="${employeeInstanceList}" status="i" var="employeeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: employeeInstance, field: "hours")}</td>
					
						<td>${fieldValue(bean: employeeInstance, field: "wage")}</td>
